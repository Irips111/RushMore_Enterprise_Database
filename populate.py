...
def mask_email(email: str) -> str:
    ...
    Example: akwajielizabethh@gmail.com -> a*******@gmail.com
    """
...
def create_stores(cur, faker, num_stores=4):
    populate_logger.info(f"Starting to create {num_stores} stores...")
    stores = []
    for _ in range(num_stores):
        address = faker.address().replace('\n', ', ')
        city = f"{faker.city()} RushMore Enterprise"
        phone_number = faker.unique.msisdn()[:12]
...
def create_customers(cur, faker, num_customers=1000):
    ...
    customers = []
    email_domains = ["gmail.com", "yahoo.com", "yahoo.co.uk", "hotmail.com", "yahoomail.com"]
    for _ in range(num_customers):
        ...
        email = masked_email
        raw_phone = faker.unique.msisdn()[:12]
...
def create_ingredients(cur, faker, num_ingredients=45):
    populate_logger.info(f"Starting to create {num_ingredients} ingredients...")
    basic = ["Mozzarella Cheese", "Pepperoni", "Tomato Sauce", "Pizza Dough", "Basil", "Oregano",
        "Mushrooms", "Onions", "Olives", "Bell Peppers", "Chicken", "Beef", "Pineapple",
        "Ham", "Bacon", "Parmesan", "Garlic", "Spinach", "Ricotta", "Sausage"]
    ...
    for name in names:
        ...
        unit = random.choice(["kg", "ml", "grams", "liters"])
...
def create_menu_items(cur, faker, num_items=25):
    populate_logger.info(f"Starting to create {num_items} menu items...")
    items = []
    categories = ["Pizza", "Drink", "Side", "Appetizer", "Seafood", "Dessert"]
    sizes = ['Small', 'Medium', 'Large', '500ml', 'N/A']

    for _ in range(num_items):
        name = f"{faker.word().capitalize()} {random.choice(['Margherita', 'Pepperoni', 'Hawaiian', 'Four Cheese', 'Spinach & Feta', 'BBQ Chicken', 'Veggie Delight', 'Meat Supreme', 'Seafood Special'])}"
...
def main():
    ...
    parser.add_argument("--stores", type=int, default=4, help="Number of stores to create")
    parser.add_argument("--customers", type=int, default=1000, help="Number of customers to create")
    parser.add_argument("--ingredients", type=int, default=45, help="Number of ingredients to create")
    parser.add_argument("--menu", type=int, default=25, help="Number of menu items to create")
    parser.add_argument("--orders", type=int, default=5000, help="Number of orders to create")
    parser.add_argument("--order_items", type=int, default=15000, help="Number of order items")
